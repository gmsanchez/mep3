...
def main():
    ...
    # Set initial poses
    if color == 'yellow':
        # robot_big.set_position(x=-1.2491, y=0.102, theta=pi / 2)
        # robot_small.set_position(x=-1.2755, y=0.44, theta=0)
        ...
        robot_big.set_position(x=1.2491, y=0.102, theta=pi / 2)
        robot_small.set_position(x=1.2755, y=0.44, theta=-pi)
        ...
        replica.set_position(x=1.2491, y=0.4369, z=0.1579, theta=-pi / 2)
